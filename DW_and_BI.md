...
&emsp;&emsp; 这种源数据表是没有删除和更新操作的表，比如操作日志表、银行流水表等，这种数据表一般会提供一列能够记载这条记录生成的历史时间，或者说这个操作发生的时间，越早的操作时间越靠前，越晚的操作时间越靠后。那么对于这类表的增量处理策略就是：<br>
...
| 101 | user_a | 牛奶 | 2019-01-03 10:10:10 | user_a | 2019-01-04 12:10:10 | admin_a |
| 102 | user_b | 啤酒 | 2019-01-03 11:10:15 | user_b | 2019-01-04 12:21:10 | admin_a |
| 103 | user_a | 面包 | 2019-01-04 13:15:10 | user_a | 2019-01-05 17:10:18 | admin_a |
